...
export type AttendanceRecord = { id: string; studentId: string; status: AttendanceStatus; type: AttendanceType; registeredClassId: string; attendedClassId: string; lateMinutes?: number | null; note?: string; student?: StudentItem; registeredClass?: ClassItem };
export type Session = { id: string; classId: string; dojoId: string; sessionDate: string; title?: string; isFinalized: boolean; records?: AttendanceRecord[]; _count?: { records: number }; class?: ClassItem };
